...
MODEL_FILE_NAME = "{}_sampling_mccfr_solver_autobattler_s_400_100000.pickle"
...
def main(_):
  MODEL_FILE_NAME = "external_sampling_mccfr_solver_autobattler_s_400_100000.pickle"
  game = open_spiel.python.games.ma_autobattler_poker.MaAutobattlerGame({"rules":400})
  with open(MODEL_FILE_NAME, "rb") as file:
    loaded_solver = pickle.load(file)
  policy = loaded_solver.average_policy()
  nash_conv = exploitability.nash_conv(game, policy, False,True)
  print("nash conv {}".format(nash_conv))
